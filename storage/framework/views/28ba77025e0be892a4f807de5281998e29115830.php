              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Handled Subjects</b> <a class="float-right"> <?php echo e($handledSubject); ?></a>
                  </li>
                </ul>
              ...
              <div class="card-body">
                ...
                <div class="active tab-pane" id="personal_info">
                  <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">lacst Name</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="First Name">
                        </div>
                      </div>
...
<?php /**PATH C:\xampp\htdocs\asms\resources\views/livewire/student/student-profile.blade.php ENDPATH**/ ?>