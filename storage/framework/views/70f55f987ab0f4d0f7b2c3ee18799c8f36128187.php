...
<head>
    ...
    <link src="<?php echo e(asset('plugins/chart.js/Chart.min.css')); ?>">
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?php echo e(asset('plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')); ?>">
  <!-- Toastr -->
  <link rel="stylesheet" href="<?php echo e(asset('plugins/toastr/toastr.min.css')); ?>">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(asset('public/fontawesome-free/css/all.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('dist/css/adminlte.min.css')); ?>">
  <!-- DataTables -->
...
<?php endif; ?>
<img class="animation__shake" src="<?php echo e(asset('/img/gasanLogo.png')); ?>" alt="AdminLTELogo" height="250" width="250">
</div>
<div class="wrapper">
    <!-- Main Header -->
    <?php if(Auth::user()->role == 'ADMIN'): ?>
...
<?php /**PATH C:\xampp\htdocs\bums\resources\views/layouts/app.blade.php ENDPATH**/ ?>